...
<body>
  ...
  <script>
        ...
        <section class="sheet">
          ...
          <div class="bucket-grid section-pad">
            ...
            <div class="chart-card wide">
              <div class="hint" style="margin-bottom:12px">家數 / 佔比 / 出貨效率 / 單次出貨產值</div>
              <div class="item-list">
                ${buckets.map(row => `
                  <details class="expander">
                    <summary>
                      <div>
                        ...
                        <div class="bucket-meta">家數 <span class="meta-num">${fmtInt(row.count)}</span> / 家數佔比 <span class="meta-num share">${fmtPct(row.customerSharePct)}</span> / 業績佔比 <span class="meta-num share">${fmtPct(row.salesSharePct)}</span> / 平均出貨 <span class="meta-num">${fmtInt(row.avgVisitsPerCustomer || 0)}</span> 次 / 單次出貨產值 <span class="meta-num">${fmtWan(row.salesPerVisit || 0)}</span></div>
    ...
    function metricNote(text, judge) {
