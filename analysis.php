...
function openDetail(sku) {
  ...
  content.innerHTML = '<div class="detail-title">'
    ...
    + '<div class="detail-field"><div class="dl">總銷售片數</div><div class="dd">' + fmtNum(p.totalQty || 0) + ' 片</div></div>'
    + '<div class="detail-field"><div class="dl">月均銷售片數</div><div class="dd">' + ((p.monthlyQty || []).reduce(function(s, v) { return s + v; }, 0) / Math.max(1, (p.monthlyQty || []).filter(function(v) { return v > 0; }).length)).toFixed(1) + ' 片/月</div></div>'
